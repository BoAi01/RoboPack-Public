    ...
    for i, seq_folder in enumerate(os.listdir(args.source_path)):
        ...
        for j, rosbag_folder in enumerate(os.listdir(seq_folder_path)):
            if 'rosbag' not in rosbag_folder:
                continue
            if ('2' in rosbag_folder or '2' in rosbag_folder):
                continue
            ...
            print(f'lengths of topics: {lens}')
            ...
            for idx in tqdm.tqdm(range(0, min_len)):        # 8, 9
                ...
                box_points = filter_point_cloud_by_height(pcs[0] + pcs[1] + pcs[2] + pcs[3], 0.015, 0.5)
                ...
                if args.debug:
                    ...
                    o3d.visualization.draw_geometries([box_points, in_hand_pc_now, ee] + bubble_sampled_pcs_o3d + pcs)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--source_path", type=str, default='/media/albert/ExternalHDD/bubble_data/v11_0828',
    ...
    parser.add_argument("--target_path", type=str,
                        default='/media/albert/ExternalHDD/bubble_data/v11_0828_parsed',
    ...
    parser.add_argument("--max_nframe", type=int, default=30, help="max number of frames in one h5 file")  # 100 frames take (19-x)G RAM
