...
SERIAL_NUMBER=${SERIAL_NUMBER:-"125322060645"}              # Connect to the camera with serial number
...
USB_PORT=${USB_PORT:-4-4}         # USB port, found in realsense-viewer
# /sys/devices/pci0000:00/0000:00:1c.4/0000:06:00.0/usb4/4-4/4-4:1.0/video4linux/video12
