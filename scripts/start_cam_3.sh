...
SERIAL_NUMBER=${SERIAL_NUMBER:-"821312060498"}              # Connect to the camera with serial number
...
USB_PORT=${USB_PORT:-2-6}         # USB port, found in realsense-viewer
# /sys/devices/pci0000:00/0000:00:14.0/usb2/2-6/2-6:1.0/video4linux/video18
